...
import { ILogin, ISetProducts, ISetRequests, ISetWallets, IUserState } from './user.types'
...
export const { loginSlice, setProducts, setWallets, setRequests } = userSlice.actions
